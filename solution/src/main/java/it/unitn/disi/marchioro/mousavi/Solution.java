...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<5;i++){
            ...
            System.out.println("Sending "+req.getType().name()+ " request ("+req.getData().toString()+") to "+actorList.getFirst().key);
        ...
        for(int i=0;i<10;i++){
            ...
            System.out.println("Sending "+req.getType().name()+ " request ("+req.getData().toString()+") to "+server.key);
